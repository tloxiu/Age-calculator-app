...
const titleDay = document.querySelector(".title-day-title");
const titleMonth = document.querySelector(".title-month-title");
const titleYear = document.querySelector(".title-year-title");
